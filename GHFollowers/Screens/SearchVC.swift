...
class SearchVC: UIViewController {
    ...
    func configureLogoImageView() {
        logoImageView.enableAutoLayout()
        logoImageView.image = Images.ghLogo
        
        let topConstraitConstant: CGFloat = DeviceTypes.isiPhoneSE || DeviceTypes.isiPhone8Zoomed ? 20 : 80
        
        logoImageTopConstraint = logoImageView.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: topConstraitConstant)
